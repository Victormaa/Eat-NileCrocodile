...
public class GameManager : MonoBehaviour
{
    ...
    [Tooltip("每次隐蔽升级消耗的资源（Money / CrocodileFat / CrocoFur 由按钮选择）")]
    ...
    /// <summary>
    /// 隐蔽升级：按 costType 扣 Money / CrocodileFat / CrocoFur；成功则提升 StealthLevel 并刷新鳄鱼。
    /// </summary>
